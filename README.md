...
Здесь описан способ работы с Git из редактора VSCode. Если вам нравится консоль, смотрите [git_cmd.md](doc/git_cmd.md).

- [Инструменты для работы](doc/git_instruments.md)
- [Как вносить правки](doc/git_add_content.md)
- [Как проводить ревью Pull Request](doc/git_review_pr.md)