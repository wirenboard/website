...
Для названий .md-файлов и картинок используйте английский язык. Не используйте пробелы (заменять на подчёркивание `_`), тире, скобки, решётки и другие специальные символы.
