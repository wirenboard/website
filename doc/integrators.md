...
1.Добавьте логотип в формате `jpg`, `webp` или `png` в папку [public/img/integrators](/public/img/integrators). Ширина изображения должна быть 500 пикселей. По высоте изображение должно быть соразмерно логотипу — без больших пустых полей сверху и снизу, с равными отступами.
