...
> «Мы используем модули Wiren Board в проектах архитектурной подсветки: управление силовыми группами, дискретные сигналы, телеметрия. Это компактные, надежные и понятные устройства, которые хорошо вписываются в нашу архитектуру и экономят место в щите»
>
> **Александр Тишков, директор компании [Light Stream](https://lightstream.pro/)**
