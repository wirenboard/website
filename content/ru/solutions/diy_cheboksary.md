...
> «Я выбрал Wiren Board не потому, что это модно, а потому что это работает. Все открыто, логика понятна, документация есть, если потребуется — все поддаётся самостоятельной диагностике и ремонту. Для инженера это идеальный набор: не коробка с магией, а система, которую ты контролируешь сам»
>
> **Александр, хозяин квартиры**
