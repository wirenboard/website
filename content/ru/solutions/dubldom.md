...
cover: dubldom/dubldom.webp
date: 2024-11-26
category: apartments_automation
---

> «Мы выбрали продукты Wiren Board, потому что они идеально соответствуют нашему видению: надежная автоматизация, которая делает дома комфортными и современными, при этом оставаясь доступной для наших клиентов»
>
> **Александр Рязанцев, главный технолог «ДубльДом»**
...
:gallery{
    :data='[
        ["dubldom/2.jpeg", "«ДубльДом Кедр Стокманн», который мы посетили"],
        ["dubldom/3.jpeg", "Сейчас пойдем знакомиться с модульным домом"],
        ["dubldom/4.jpeg", "К перелеску обращена веранда, на которой можно комфортно отдохнуть в теплую погоду"],
        ["dubldom/5.jpeg", "Фото с производства: из этих досок собирают модули дома"]
    ]'
}
...
:gallery{
    :data='[
        ["dubldom/6.jpeg", "«ДубльДом Кедр Стокманн», который мы посетили"],
        ["dubldom/7.jpeg", "Она же — рабочий кабинет. Обратите внимание на радиатор под столом"],
        ["dubldom/8.jpeg", "В гостиной установили дровяную печь-камин"],
        ["dubldom/9.jpeg", "Здесь же — обеденный стол"]
    ]'
}
...
:gallery{
    :data='[
        ["dubldom/10.jpeg", "Из гостиной можно выйти на веранду, слева — вход в детскую"],
        ["dubldom/11.jpeg", "Гостиная, вверху можно увидеть кондиционер. Слева — прихожая-кабинет, справа — мастер-спальня"],
        ["dubldom/12.jpeg", "Вентиляция  в штатной комплектации"],
        ["dubldom/13.jpeg", "Беспроводной датчик температуры Z-Wave, под ним — пульт кондиционера"]
    ]'
}
...
:gallery{
    :data='[
        ["dubldom/14.jpeg", "Кухня совмещена с  гостиной"],
        ["dubldom/15.jpeg", "Красивые светильники на кухне"],
        ["dubldom/16.jpeg", "Мастер-спальня"],
        ["dubldom/17.jpeg", "Пространство над кроватью красиво украшено"]
    ]'
}
...
:gallery{
    :data='[
        ["dubldom/18.jpeg", "Щит автоматизации модульного дома"],
        ["dubldom/19.jpeg", "Скриншоты приложения умного дома"],
        ["dubldom/20.jpeg", "Щит автоматизации около ворот"],
        ["dubldom/21.jpeg", "Пространство над кроватью в детской тоже красиво украсили"]
    ]'
}
