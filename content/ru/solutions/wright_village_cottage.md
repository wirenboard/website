...
> «Мне в Wiren Board нравится универсальность. Эти модули одинаково хорошо управляют и тёплыми полами, и вентиляцией, и воротами, и даже автополивом. Это не какая-то экзотика под одну задачу, а рабочие кирпичики, из которых можно собрать всё, что нужно в доме»
>
> **[Антон](https://habr.com/ru/users/Matoxa/), хозяин дома**
