...
> «Wiren Board — штука гибкая. Если всё грамотно подключить и настроить, можно весь дом автоматизировать. Мне нравится, что он не привязан к облакам — всё под нашим контролем.»
>
