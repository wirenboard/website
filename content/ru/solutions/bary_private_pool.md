...
> «Контроллеры Wiren Board — это универсальная платформа. Они одинаково хорошо управляют и умным домом, и инженерными системами. Для нас это значит, что мы можем собрать весь объект на едином оборудовании под управлением софта BARY»
>
> **Айдар Сабирзянов, директор компании [BARY](https://bary.io/)**
