...
> «Контроллеры Wiren Board хорошо подходят для диспетчеризации объектов, мы используем их для сбора информации со всех видов датчиков и различного оборудования, в том числе с контроллеров Kaplestop»
>
> **Леонид Кушнир, директор Green Signal**
