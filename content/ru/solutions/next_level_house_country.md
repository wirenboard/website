...
> «Контроллеры Wiren Board универсальны и поддерживают множество сторонних устройств. Открытая платформа облегчает разработку сценариев, а квалифицированная техническая поддержка оперативно решает задачи клиентов.»
>
> **Андрей Серебряков, основатель Next Level House**
