...
> «Оборудование Wiren Board хорошо подходит для подобных задач: оно компактное, гибкое в настройке, с открытой архитектурой. Мы можем быстро реализовать необходимую логику, без зависимости от закрытого ПО или лицензий. А возможность управлять и настраивать систему прямо в веб\-интерфейсе — это просто удобно для заказчика»
>
