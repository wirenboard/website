...
> «Оборудование Wiren Board зарекомендовало себя как надежная и гибкая платформа для интеграции наших BLE-датчиков и BLR-баз TESLiOT-X. Использование нашего совместного решения позволяет в короткие сроки создавать эффективные системы мониторинга микроклимата с высокой точностью и стабильностью работы.»
>
> **Дмитрий Кротов, директор TESLA SMART UZ**
