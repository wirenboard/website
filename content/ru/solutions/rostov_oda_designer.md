...
> «С Wiren Board мы собираем и квартиры, и храмы, вообще все. Один контроллер под множество задач. А если что-то нужно расширить, просто докупаем модули и дописываем логику.»
>
