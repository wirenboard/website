...
> «В этом проекте оборудование Wiren Board закрыло задачи по освещению, управлению шторами, теплыми полами и защите от протечек»
>
> **Олег Войлов, интегратор «Демос»**
