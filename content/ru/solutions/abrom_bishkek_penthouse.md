...
> «Wiren Board — это стабильная платформа с открытой архитектурой, удобная для настройки и отладки на объекте.»
>
> **Минуллин Магди, технический директор интегратора Abrom**
...
:gallery{
    :data='[
        ["abrom_bishkek_penthouse/2.jpeg", "Лестница на второй уровень с подсветкой. Цветы — подарок на новоселье"],
        ["abrom_bishkek_penthouse/3.jpeg", "Семиметровые шторы вручную открывать проблематично, без электропривода не обойтись"],
        ["abrom_bishkek_penthouse/4.jpeg", "Винтовая лестница на верхний уровень"],
        ["abrom_bishkek_penthouse/5.jpeg", "Гостиная, вид со второго уровня"]
    ]'
}
...
:gallery{
    :data='[
        ["abrom_bishkek_penthouse/6.jpeg", "Вид в гостиную со стороны кухни"],
        ["abrom_bishkek_penthouse/7.png", "План первого уровня с расстановкой мебели"],
        ["abrom_bishkek_penthouse/8.png", "План второго уровня с расстановкой мебели"],
        ["abrom_bishkek_penthouse/9.png", "План верхнего уровня с расстановкой мебели"]
    ]'
}
...
Для контроля энергопотребления и качества электрической энергии установили измеритель WB-MAP3E. Информацию с него можно посмотреть в веб-интерфейсе контроллера или приложениях.

:gallery{
    :data='[
        ["abrom_bishkek_penthouse/10.jpeg", "Главный щит автоматизации на первом уровне"],
        ["abrom_bishkek_penthouse/11.jpeg", "Контроллер Wiren Board и модули дискретных входов"],
        ["abrom_bishkek_penthouse/12.jpeg", "Щит автоматизации на втором уровне"],
        ["abrom_bishkek_penthouse/13.jpeg", "Релейные модули"]
    ]'
}
...
Изначально интегратор хотел управлять системой кондиционирования Daikin через модули ONOKOM. После нескольких недель экспериментов с существующими модулями заказчик решил отказаться от интеграции кондиционеров в систему автоматизации. Возможно, к этому вопросу вернутся в будущем, когда выйдут модули ONOKOM, умеющие работать с данными кондиционерами.
...
:gallery{
    :data='[
        ["abrom_bishkek_penthouse/14.jpeg", "Справа и слева установлены два крана GIDROLOCK ULTIMATE"],
        ["abrom_bishkek_penthouse/15.jpeg", "Настенные светильники в гостиной"],
        ["abrom_bishkek_penthouse/16.jpeg", "Разные группы светильников в гостиной"],
        ["abrom_bishkek_penthouse/17.jpeg", "Семиметровые шторы в гостиной"]
    ]'
}
