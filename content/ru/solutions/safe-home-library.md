...
> «В библиотеке мы применили тот же подход, что и на промышленных объектах: надёжность в приоритете. Контроллеры Wiren Board нам позволяют закрыть множество задач без лишнего оборудования»
>
> **Александр Михалев, директор [SAFE-HOME.PRO](http://SAFE-HOME.PRO)**
