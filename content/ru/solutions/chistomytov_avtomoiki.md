...
> «В нашей работе мы начали использовать модули Wiren Board с первых версий WB-MAI11. Затем перешли на более компактные WB-MAI6 — надежные, помехоустойчивые и легко встраиваемые в Modbus-подсистему контроллера. Релейные модули Wiren Board также удобны и практичны. Всё работает стабильно годами»
>
> **Андрей Демшин, инженер, разработчик систем управления для сети автомоек «Чистомытов»**
