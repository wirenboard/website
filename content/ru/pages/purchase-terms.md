...
| от 500 штук**      | 13%          | 17%          | 5%           | 7%           |
| от 1000 штук**     | 19%          | 19%          | 10%          | 10%          |

Устройствами одного наименования могут считаться также устройства одной модели в разных комплектациях.

\* Категория A: Контроллеры Wiren Board, модули расширения и модули ввода-вывода к ним, устройства WB-MIO.
...
\* Категория T: Трансформаторы тока.
