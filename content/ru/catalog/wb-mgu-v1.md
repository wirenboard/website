...
Разница между MGE и MGU (они на одной элементной базе, но отличаются тем, что вместо второго порта в MGU есть слот для модулей WBE2, нет MIO-конвертера, и добавлена PSRAM-память):
