...
Если вам нужен шлюз RS-485 ⇄ Ethernet/Wi-Fi, то это **[WB-MGE v.3](/ru/contents/product/wb-mge-v3/)**, его можно взять и купить в любой момент.

Разница между MGE и MGU (они на одной элементарной базе, которые отличаются тем что вместо второго порта в MGU есть слот для модулей WBE2, нет MIO-конвертера, и добавлена PSRAM-память):
...
:photo{
  src="wb-mgu-v1/wb-mgu-v1-indication_1.png"
  width="500px"
  float="right"
}
...
:photo{
  src="wb-mgu-v1/wb-mgu-v1-fast-modbus_1.png"
  float="right"
  width="500px"
}
...
:photo{
  src="wb-mgu-v1/wb-mgu-v1-reset_1.png"
  float="right"
  width="500px"
}
