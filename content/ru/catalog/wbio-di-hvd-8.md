...
Модуль WBIO-DI-HVD-8 предназначен для контроля состояния автоматических выключателей, опроса сигнальных ламп и т.п.

Устройство содержит восемь дискретных входов с групповой гальванической развязкой, разделённых на две изолированные группы. Срабатывание входа происходит при подаче переменного напряжения от 110В.
