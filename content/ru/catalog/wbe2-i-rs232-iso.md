...
::product
#description
Модуль добавляет гальванически изолированный интерфейс RS-232 в контроллеры Wiren Board. Устанавливается во внутренний слот на плате контроллера. Физический уровень интерфейса реализован на MAX232.
