::product-section{title="Подбор трансформатора по току"}

Для получения более точных измерений, при прочих равных, выбирайте трансформатор тока с большим диаметром отверстия. Увеличенные размеры сердечника улучшают измерительные свойства ТТ и снижают погрешность.

| Модель трансформатора | Измеряемый ток, А | Класс точности | Диаметр отверстия, мм | Тип сердечника |
| --- | --- | --- | --- | --- |
| [ZMCT102w](https://wirenboard.com/ru/product/ZMCT102w/) | 0.15…45 | 0.2S | 5 | Неразъёмный |
